...
if ( ! function_exists( 'imicra_setup' ) ) :
	...
	function imicra_setup() {
		...
		register_nav_menus(
			array(
				'primary-menu' => esc_html__( 'Main', 'imicra' ),
			)
		);
...
function imicra_scripts() {
	...
	// wp_enqueue_style( 'imicra-style-libs', get_template_directory_uri() . '/assets/css/libs.min.css' );

	wp_enqueue_style( 'imicra-style', get_template_directory_uri() . '/assets/css/style.min.css', array(), _S_VERSION );

	// wp_enqueue_script( 'imicra-scripts-libs', get_template_directory_uri() . '/assets/js/libs.min.js', array( 'jquery' ), _S_VERSION, true );

	wp_enqueue_script( 'imicra-scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array( 'jquery' ), _S_VERSION, true );
